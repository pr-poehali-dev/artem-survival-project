...
export const RECIPE_DETAILS: Record<string, { ingredients: string[]; steps: string[] }> = {
  ...
  "Омлет классический": {
    ingredients: ["3 яйца", "3 ст.л. молока", "1 ч.л. сливочного масла", "Соль по вкусу", "По желанию: зелень, сыр"],
    steps: [
      "Разбей яйца в миску, добавь молоко и щепотку соли. Взбей вилкой или венчиком до однородности — без фанатизма, 30 секунд.",
      "Разогрей сковороду на среднем огне, добавь масло и дай ему растаять, распределив по дну.",
      "Вылей яичную смесь — она должна зашипеть. Это хороший знак!",
      "Когда края начнут схватываться, подними их лопаткой и наклони сковороду — жидкая часть стечёт под омлет.",
      "Как только середина почти не жидкая — сложи омлет пополам или рулетом и выложи на тарелку. Готово!",
    ],
  },
};
...
export const RECIPES = [
  ...
  { emoji: "🥚", title: "Омлет классический",   desc: "Пышный омлет с молоком — завтрак за 5 минут.",          time: "5 мин"  },
];
