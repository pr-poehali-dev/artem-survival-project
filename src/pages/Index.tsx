...
const MUSIC_GENRES = [
  ...
  },
  {
    ...
    tracks: [
      ...
      { title: "Jurassic Park Theme — John Williams",        ytId: "PYI09PMNazs" },
      { title: "Welcome to Jurassic World — Michael Giacchino", ytId: "3DOzJEb85wg" },
      { title: "Rex Doesn't Want to Eat — Williams",         ytId: "RVDjVxBdT2w" },
      { title: "Jurassic World Theme — Giacchino",           ytId: "h8ifx2_eCZw" },
    ],
